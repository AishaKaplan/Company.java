    ...
    public static void main(String[] args) {
        ...
        switch (numberOfPeople){
            ...
            case 4:
                ...
                break;
                //When the value is 3 or 4 it runs the same code above. Same result for 3 people and 4 people.
            case 5:
            case 6:
                roomType= "Suite";
                price=5000;
                //The price for both 5 and 6 will be the same.
            default:
                System.out.println("Party size is invalid");
