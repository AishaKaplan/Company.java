...
public class SumNumbersFromList {
 ...
 public static void main(String[] args) {
    ArrayList<String> numbers=new ArrayList<>(Arrays.asList("12345"));
     System.out.println(getSumOfString(numbers));
 }
    public static ArrayList<Integer> getSumOfString (ArrayList<String> list) {
        ...
        return numbers;   // challenge: extract the inner loop, make it a helper method
    }
    }
